...
完整 skill framework 在 repo root 的 `skill/hks-knowledge-system/`。先讀：

1. `skill/hks-knowledge-system/README.md`：skill 框架與檔案地圖
2. `skill/hks-knowledge-system/commands/cli.md`：完整 `ks` command surface
